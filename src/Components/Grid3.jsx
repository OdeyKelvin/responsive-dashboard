...
<div
        ...
        <label className='text-gray-400 self-center text-xl'>Completed</label>
        <button className='border-2 bg-black rounded-lg w-12  h-12 my-2 font-semibold text-xl whitespace-nowrap self-center text-white'>2</button>
      </div>
        ...
        <div className='w-10/12 mx-auto space-y-3'>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
              <div className=" bg-green-400 h-2.5 rounded-full dark:bg-blue-500 w-1/5"></div>
            </div>
